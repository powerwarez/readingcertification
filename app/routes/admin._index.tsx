...
export function loader() {
  return json({
    ...
    cards: [
      {
        title: "학생 관리",
        description: "학생 계정을 생성하고 관리할 수 있습니다.",
        link: "/admin/students",
      ...
      {
        title: "도전과제 관리",
        description: "재미있는 독서 도전과제와 뱃지를 만들어보세요.",
      ...
      {
        title: "리더보드",
        description: "학생들의 독서 활동 순위와 통계를 확인하세요.",
      ...
      {
        title: "교사 관리",
        description: "다른 선생님들과 함께 관리해보세요.",
        link: "/admin/teachers",
        iconName: "Users",
        color: "bg-gradient-to-r from-purple-400 to-violet-300",
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {data.cards.map((card, index) => (
          <Link key={index} to={card.link} className="block transform hover:scale-105 transition-all duration-300" prefetch="intent">
      ...
      <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="rounded-2xl shadow-lg border-2 border-green-100 overflow-hidden">
          ...
          <CardHeader>
            <CardTitle className="text-2xl font-jua text-green-700">빠른 통계</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-xl flex justify-between items-center">
                <p className="text-blue-700 font-jua">참여 학생 수</p>
                <div className="flex items-center gap-2">
